...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handlePostNotFoundException(Exception e, WebRequest request) {
	...
	/**
	 * Method argument valiation exception.
	 */
	@Override
